...
<div class="header-div">
    ...
    <div class="booking">
    <h2>Discover Bali - Top Attractions</h2>
   
   <div class="images">
   <img src="img/Bali1.jpg" alt="" class="slide">
   <img src="img/Bali2.jpg" alt="" class="slide">
   <img src="img/Bali3.jpg" alt="" class="slide">
   <img src="img/Bali4.jpg" alt="" class="slide">
   <img src="img/Bali5.jpg" alt="" class="slide">
    </div>
    ...
    <script>
      ...
      window.onload=change;
        ...
        <p><b>Day 1:</b>&nbsp;&nbsp;Arrival in Denpasar Bali via flight&nbsp;&nbsp;|Check-in to Hotel in Bali</p><hr>
        <p><b>Day 2:</b>&nbsp;&nbsp;Breakfast at Hotel in Bali</p><hr>
        <p><b>Day 3:</b>&nbsp;&nbsp;Breakfast at Hotel in Bali</p><hr>
        <p><b>Day 4:</b>&nbsp;&nbsp;Breakfast at Hotel in Bali</p><hr>
        <p><b>Day 5:</b>&nbsp;&nbsp;Breakfast at Hotel in Bali</p><hr>
        <p><b>Day 6:</b>&nbsp;&nbsp;Breakfast at Hotel in Bali</p><hr>
        <p><b>Day 7:</b>&nbsp;&nbsp;Breakfast at Hotel in Bali&nbsp;&nbsp;|Checkout from Hotel in Bali&nbsp;&nbsp;|Departure from Denpasar Bali via flight</p><hr>
...
<label for="check">I accept the terms and conditions</label><br><br>
        ...
        function totalPrice()
            ...
            var total = val1 * 55110  + val2 * (55110 /2);
